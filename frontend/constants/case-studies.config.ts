...
export const caseStudies: CaseStudy[] = [
  {
    ...
    metrics: [
      { label: 'Rate per Mile', before: '$0.38/mile', after: '$2.15/mile' },
  ...
  },
  {
    ...
    revenueIncrease: '+$9,320/month',
    revenueIncreaseValue: 9320,
    rpmBefore: '$1.10',
    rpmAfter: '$3.80',
    ...
    metrics: [
      { label: 'Rate per Mile', before: '$1.10/mile', after: '$3.80/mile' },
      { label: 'Monthly Net Income', before: '-$420 (loss)', after: '+$8,900 profit' },
  ...
  },
  {
    ...
    revenueIncrease: '+$1,350/trip',
    revenueIncreaseValue: 1350,
    rpmBefore: '$1.10',
    rpmAfter: '$1.90',
  ...
  },
  {
    ...
    revenueIncrease: '+$31,000/year',
    revenueIncreaseValue: 31000,
    rpmBefore: '$1.60',
    rpmAfter: '$2.05',
    ...
    metrics: [
      { label: 'Rate Premium (Hazmat)', before: 'None claimed ($1.60/mi)', after: '+$0.45/mi ($2.05/mi)' },
      ...
      { label: 'Annual Revenue Increase', before: 'Baseline', after: '+$31,000/year' },
    ],
  },
  {
    id: '8',
  ...
  },
  {
    ...
    revenueIncrease: '+$47,000/year',
    revenueIncreaseValue: 47000,
    rpmBefore: '$1.70',
    rpmAfter: '$2.95',
    ...
    metrics: [
      { label: 'Load Type', before: 'General tanker ($1.70/mi)', after: 'Specialty liquid ($2.95/mi)' },
      { label: 'Detention Recovered', before: '$0 collected', after: '$3,100 recovered' },
      { label: 'Permit Costs', before: '$300/trip', after: '$0 (rerouted)' },
      { label: 'Annual Revenue Lift', before: 'Baseline', after: '+$47,000/year' },
    ],
  },
  {
    id: '11',
    ...
    revenueIncrease: '+400% home time',
    revenueIncreaseValue: 0, // Quality of life metric
    rpmBefore: '$1.85',
    rpmAfter: '$1.70',
    ...
    metrics: [
      ...
      { label: 'Revenue vs. Before', before: '$12,400/month', after: '$11,200/month (-10%)' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Rate per Mile', before: '$0.92/mile', after: '$1.85/mile' },
  ...
  },
  {
    ...
    equipmentType: 'Dry Van',
    equipmentBadge: '53\' Dry Van',
    revenueIncrease: '+$17,500 recovered',
    revenueIncreaseValue: 17500,
    rpmBefore: '$1.70',
    rpmAfter: '$1.95',
  ...
  },
  {
    ...
    equipmentType: 'Reefer',
    equipmentBadge: '53\' Refrigerated Trailer',
    revenueIncrease: '+$2,250/cycle',
    revenueIncreaseValue: 2250,
    rpmBefore: '$1.20',
    rpmAfter: '$2.10',
  ...
  },
  {
    ...
    equipmentType: 'Dry Van',
    equipmentBadge: '53\' Dry Van',
    revenueIncrease: '+$1.15/mile',
    revenueIncreaseValue: 0, // Percentage-based
    rpmBefore: '$0.95',
    rpmAfter: '$2.10',
    ...
    metrics: [
      ...
      { label: 'Rate per Mile', before: '$0.95/mile (negotiated down)', after: '$2.10/mile (Grow Trucking rate)' },
