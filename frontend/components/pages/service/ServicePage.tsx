...
export default function ServicePage({ service }: ServicePageProps) {
    return (
        <main className="min-h-screen bg-white">
            ...
            <PageBanner
                title={service.title}
                description={service.subheading || service.description}
                breadcrumbItems={[
                    { label: 'Home', href: '/' },
                ...
                <section className="py-8 sm:py-12 md:py-16 lg:py-24 bg-white">
                    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20">
                            ...
                            <div className={service.overview.imageUrl ? "lg:w-1/2 w-full" : "w-full"}>
            ...
            {service.whyChooseUs && service.whyChooseUs.points.length > 0 && (
                ...
                <section className="py-8 sm:py-12 md:py-16 lg:py-24 bg-white">
                    <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20">
                            ...
                            {service.additionalInfo.imageUrl && (
                                <div className="lg:w-1/2 w-full order-2 lg:order-1">
                                    <div className="relative group">
                                        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl sm:shadow-2xl border-2 sm:border-4 border-white">
                                            <Image
                                                src={service.additionalInfo.imageUrl}
                                                alt={service.title}
                            ...
                            <div className={service.additionalInfo.imageUrl ? "lg:w-1/2 w-full order-1 lg:order-2" : "w-full"}>
                                <Badge className="mb-3 sm:mb-4 md:mb-6 text-xs sm:text-sm">
